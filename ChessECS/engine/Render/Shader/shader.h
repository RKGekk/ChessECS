...
public:
	...
	void set_mat3x3(const char* name, const glm::mat3& matrix, bool transpose = false) const {
		glUniformMatrix3fv(glGetUniformLocation(get_shader_program(), name), 1, transpose, glm::value_ptr(matrix));
	}

	void set_mat3x3(int uniform_location, const glm::mat3& matrix, bool transpose = false) const {
		glUniformMatrix3fv(uniform_location, 1, transpose, glm::value_ptr(matrix));
	}
	void set_mat4x4(const char* name, const glm::mat4 matrix, bool transpose = false) const {
		glUniformMatrix4fv(glGetUniformLocation(get_shader_program(), name), 1, transpose, glm::value_ptr(matrix));
	}

	void set_mat4x4(int uniform_location, const glm::mat4 matrix, bool transpose = false) const {
	...
	void set_vec2(int uniform_location, const glm::vec2& v) const {
	...
	void set_vec3(int uniform_location, const glm::vec3& v) const {
	...
	void set_vec4(int uniform_location, const glm::vec4& v) const {
