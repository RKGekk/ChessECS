...
Texture2D::Texture2D(const std::string& path, TextureColorFormat colorFormat, TextureFormat textureFormat, TexturePixelFormat pixelFormat, TextureWrappFormat wrapping, bool generate_mips) {
