...
namespace ecs {
	...
	EntityPullIterator::EntityPullIterator(const EntityPull& container, int bin, int index) : container(container), bin(bin), index(index) {}
	...
	EntityPull::EntityPull() : entities(), totalCount(0), destroyCount(0), entityCapacity(0) {}
