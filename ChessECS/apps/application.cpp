...
Application::Application(const string &window_name, const string &project_path) : context(window_name), timer(), sceneManager(), projectPath(project_path), projectResourcesPath(project_path + "/Resources"), projectShaderPath(project_path + "/Shaders") {
    application = this;
    compile_shaders();
}
